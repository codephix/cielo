    ...
    protected function sendRequest($method, $url, \JsonSerializable $content = null)
    {
        ...
        if ($content !== null) {
            ...
            $content = '{  
                ...
                "Customer":
                {  
                    "Name":"Max Alex Arruda da Silva",
                    "Identity": "09743799486",
                    "Address":
                    {
                        "Street": "Rua campo de pouso",
                        "Number": "102",    
                        "Complement": "Tor 12 apt 304",
                        "ZipCode" : "53441625",
                        "District": "Maranguape I",
                        "City": "Paulista",
                        "State" : "PE",
                        "Country": "BRA"
                    },
